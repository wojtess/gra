...
namespace Entity {
    ...
    void Zombie::render(Renderer::ResourceMap& resourceMap, bool flipped, bool effects) {
    ...
    void Player::render(Renderer::ResourceMap& resourceMap, bool flipped, bool effects) {
    ...
    void DropedItem::render(Renderer::ResourceMap& resourceMap, bool flipped, bool effects) {
...
void Building::render(Renderer::ResourceMap& resourceMap, bool flipped, bool effects) {
...
namespace Hud {
    ...
    void Button::render(Renderer::ResourceMap& resourceMap, bool flipped, bool effects) {
    ...
    void Label::render(Renderer::ResourceMap& resourceMap, bool flipped, bool effects) {
